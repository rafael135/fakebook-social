<nav class="fixed top-0 z-50 w-full border-b border-gray-900 bg-gradient-to-r from-slate-800 from-70% to-slate-900 dark:bg-gray-800 dark:border-gray-700">
...
<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full border-r border-gray-900 bg-gradient-to-r from-slate-800 from-70% to-slate-900 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
    aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-gradient-to-r from-slate-800 from-70% to-slate-900 dark:bg-gray-800">
