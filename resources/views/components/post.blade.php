<div class="post lg:w-180 lg:max-w-180 flex flex-col border-solid border bg-gray-100 border-gray-400" data-post-id="{{$post->id}}">
    <div class="post-header px-2 py-1 flex border-solid border-b border-gray-300">
        ...
        -->
            ...
            <!-- Dropdown menu -->
            <div id="post-opts-dropdown-{{$post->id}}" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="posts-opts-dropdown-btn-{{$post->id}}">
                    <li>
